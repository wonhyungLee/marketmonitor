...
function parseTimingV1Row(row: any): TimingV1Row {
  return {
    ...
    crisis_now: toNum(row.crisis_now),
    euphoria_now: toNum(row.euphoria_now),

    // CSV uses *_within_* naming
    p_crisis_within_1m: toNum(row.p_crisis_within_1m),
    p_crisis_within_3m: toNum(row.p_crisis_within_3m),
    p_crisis_within_6m: toNum(row.p_crisis_within_6m),
    p_crisis_within_1y: toNum(row.p_crisis_within_1y),
    p_crisis_within_2y: toNum(row.p_crisis_within_2y),
    p_crisis_within_3y: toNum(row.p_crisis_within_3y),
    p_crisis_within_5y: toNum(row.p_crisis_within_5y),
    p_crisis_within_10y: toNum(row.p_crisis_within_10y),

    p_euphoria_within_1w: toNum(row.p_euphoria_within_1w),
    p_euphoria_within_1m: toNum(row.p_euphoria_within_1m),
    p_euphoria_within_3m: toNum(row.p_euphoria_within_3m),
    p_euphoria_within_6m: toNum(row.p_euphoria_within_6m),
    p_euphoria_within_1y: toNum(row.p_euphoria_within_1y),
    p_euphoria_within_2y: toNum(row.p_euphoria_within_2y),
